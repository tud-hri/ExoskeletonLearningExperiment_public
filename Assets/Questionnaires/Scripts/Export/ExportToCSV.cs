...
namespace VRQuestionnaireToolkit
{
    public class ExportToCSV : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            //StorePath = _session.ParticipantPath;
            //_allResultsPath = _session.BasePath;
            //_ppID = _session.ppid;
            ...
            _folderPath = UseGlobalPath ? StorePath : StorePath;
        ...
        public void Save()
        {
            ...
            var ppID = Session.instance.ppid;
            var pathParticipant = fs.GetSessionPath(Session.instance);

            string _completeFileName =  _questionnaireID + "_" + ppID + "." + _fileType;
            string _completeFileName_allResults =  _questionnaireID + "_" + "_ALL" + "." + _fileType;
            string _path = pathParticipant + _completeFileName;
            //string _path_allResults = _allResultsPath + _completeFileName_allResults;
            string _path_allResults = _path + _completeFileName_allResults;
